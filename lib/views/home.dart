...
import 'package:flutter_recipe_api/views/recipe_view.dart';
import 'package:http/http.dart' as http;
import 'package:flutter_recipe_api/models/recipe_model.dart';
import 'package:flutter_recipe_api/views/recipe_view.dart';
                          ...
                          InkWell(
                              onTap: () async {
                                if (textEditingController.text.isNotEmpty) {
                                  ...
                                  recipies = [];
                                  String url =
                                      "https://api.edamam.com/search?q=${textEditingController.text}&app_id=bfd8d35e&app_key=e2e44e81fb8345ed3c50e2fe5b1bbdb8";
        ...
        GestureDetector(
          onTap: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => _launchURL(widget.url)));
          },
          child: Container(
